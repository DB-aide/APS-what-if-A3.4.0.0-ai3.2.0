...
try:
    """
        virtual environment for Debian 13
        If matplotlib is not installed in Debian 13
    ...
    print("matplotlib is geïnstalleerd")
except ImportError:
    print("matplotlib ontbreekt")
    plt = None
